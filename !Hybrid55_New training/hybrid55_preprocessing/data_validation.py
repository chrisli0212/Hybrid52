...
KNOWN_ZERO_COLUMNS = {
    ...
    'dual_gamma',
    'iv_error',
    # Observed dead/constant in historical Theta exports
...
def get_feature_columns_by_group() -> Dict[str, List[str]]:
    return {
        ...
        'greeks_2nd_order': ['vanna', 'charm', 'vomma', 'veta', 'color'],
        'greeks_3rd_order': ['ultima'],
        'greeks_other': ['dual_delta'],
        'pricing': ['bid', 'ask', 'underlying_price'],
...
TRADE_QUOTE_ALWAYS_CONSTANT = {
    ...
    'bid_condition': 50,
    'ask_condition': 50,
    # Some raw feeds carry these as fixed metadata fields.
    'endpoint': 0,
    'batch_id': 0,
    'ts': 0,
}
