...
Combines per-agent Stage 2 cross-symbol fusion probabilities
(A, B, C, K, TQ, H, M, 2D) into a final SPXW directional signal.

Input features:
  [prob_A, prob_B, prob_C, prob_K, prob_TQ, prob_H, prob_M, prob_2D]
...
Prerequisites:
  Stage 2 per-agent probs from:
    train_stage2_per_agent.py   (agents A/B/C/K/TQ/H)
