...
Phase 2: Train Stage 1
  python scripts/stage1/train_binary_agents_v2.py --symbol SPXW --horizon 15

Phase 3: Train Stage 2 + 3 (after Stage 1 diversity verified)
  python scripts/stage2/train_stage2_pairs.py --target SPXW --horizon 15
  python scripts/stage3/train_stage3_meta.py --target SPXW --horizon 15
```
