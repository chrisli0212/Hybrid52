...
def build_vix_tier3(
    ...
    if not src.exists() and bootstrap_from_raw:
        ...
        build_vixw_minutes(
            Path("/workspace/data/data_in_2026/Options_greek/VIXW"),
            Path("/workspace/data/data_in_2026/Options_trade_quote/VIXW"),
            src,
        )
    ...
    logger.info(f"  Resolution={resolution}: {bars_desc}")
